...
from core.state_graph import run_day1_state_graph

app = FastAPI(title="Sentinel-CR AI Engine Python", version="0.1.0-day1")
...
async def run_review(request: InternalReviewRunRequest) -> StreamingResponse:
    async def event_stream() -> AsyncIterator[str]:
        async for event in run_day1_state_graph(request):
